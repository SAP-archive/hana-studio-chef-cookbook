...
# # Get current state
# # studio_installed = ::File.exist?(studio) # TODO: ohai? skip?  it doesn't really belong here...
...
hana_studio node['hana-studio']['install_dir'] do
  source node['sap']['hanastudio']
  extractor node['sap']['sapcar'] if node['sap']['sapcar'] # otherwise it is assumed to be a zipfile
